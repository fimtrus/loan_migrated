 ...
 * 
 * @author <a href="mailto:badnom@kangwoo.kr">badnom</a>
 * @version 1.0
 * @since 1.0
 */
public class ByteUtils {
    ...
    /**
     * unsigned byte(바이트)를 2진수 문자열로 바꾼다.
     * (참고:자바의 바이트는 범위가 -128에서 127까지이다.)
	 * <pre>
	 * ByteUtils.toBinaryString((byte)1)   = "00000001"
	 * ByteUtils.toBinaryString((byte)255)  = "11111111"
	 * </pre>
	 * 
     * @param b unsigned byte
     * @return 2진 문자열
